...
AC_DEFUN([CIT_PATH_VTK],[
    ...
    if test x$with_vtk != "xno"; then
        ...
        if test -z "$vtkFound"; then
            ...
            if test "${VTK_MAJOR}" -gt "5" ; then
              VTK_LIBS="-l$lib_vtkIO -lvtkIOParallelXML$vtk_suffix -lvtkIOXML$vtk_suffix -lvtkIOImage$vtk_suffix -lvtkIOLegacy$vtk_suffix -lvtkParallelMPI$vtk_suffix -lvtkDICOMParser$vtk_suffix -lvtkRenderingCore$vtk_suffix -lvtkRenderingLabel$vtk_suffix -lvtkRenderingAnnotation$vtk_suffix -lvtkFiltersGeneral$vtk_suffix -lvtkFiltersVerdict$vtk_suffix -lvtkFiltersCore$vtk_suffix -lvtkFiltersGeneric$vtk_suffix -lvtkCommonExecutionModel$vtk_suffix -lvtkCommonDataModel$vtk_suffix -lvtkCommonCore$vtk_suffix -lvtkInteractionStyle$vtk_suffix $VTK_SUPPORT_LIBS -lvtksys$vtk_suffix"
            else
