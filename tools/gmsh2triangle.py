...
optparser.add_option("--shell", "-s", help="interpret a 3d input mesh as a 2d "
                     "mesh on a spherical shell", action="store_const",
                     const=True, dest="spherical_shell", default=False)

optparser.add_option("--internal-boundary", "-i", help="mesh contains "
                     ...
                     action="store_const", const=True, dest="internal_faces",
                     default=False)
