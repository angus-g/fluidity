...
contains
  ...
  subroutine assemble_advection_diffusion_element_cg(ele, t, matrix, rhs, &
                                      ...
                                      velocity, grid_velocity, &
                                      source, absorption, diffusivity, &
                                      density, olddensity, pressure, nvfrac, supg_shape)
    ...
    ! Mass
    if(have_mass) call add_mass_element_cg(ele, test_function, t, density, olddensity,  nvfrac, detwei, detwei_old, detwei_new, matrix_addto, rhs_addto)
